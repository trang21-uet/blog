...
const BLOGS: Blog[] = [
  {
    ...
    paragraphs: [
      ...
      },
      {
        title: "Body",
        content:
          "But in one way or another you will react. So that's it. When this reaction happens inside the web browser instead of you this calls React.",
      },
      {
        title: "Conclusion",
        content:
          "Unlike traditional web apps when you click something or drag something that instant React, that instant data fetch without reloading the webpage. Yes my friend when you can achieve this kind of behavior using a JavaScript library called React. That is React JS.",
      },
    ],
    description:
  ...
  },
  {
    ...
    description: "Tại sao lập trình viên web nên biết dùng Lorem Ipsum",
  ...
  },
  {
    ...
    description: "Tại sao JSON lại phổ biến trong lập trình ứng dụng web?",
  ...
  },
  {
    ...
    paragraphs: [
      {
        title:
          "Point 1: Japan is a major player in the global technology industry",
        content:
      ...
      {
        title:
          "Point 2: Japan is also a major market for technology products and services",
        content:
      ...
      {
        title:
          "Point 3: Additionally, Japan has a unique culture and way of doing things",
        content:
      ...
      {
        title:
          "Point 4: Furthermore, learning a new language can be a valuable skill",
        content:
      ...
      {
        title:
          "Point 5: Finally, many people around the globe love Anime and Manga",
        content:
  ...
  {
    title:
      'Stephen Hawking: "Trí tuệ nhân tạo sẽ là dấu chấm hết cho loài người"',
    paragraphs: [
      {
        title:
          "Stephen Hawking đã tuyên bố trong hội nghị Zeitgeist 2015 tại London",
        content:
      ...
      {
        title:
          "Stephen Hawking đưa ra một dự đoán đáng lo ngại cho tương lai của nhân loại với trí thông minh nhân tạo",
        content:
      ...
      {
        title:
          "Đây không phải là lần đầu tiên Hawking đã chỉ ra việc công nghệ phát triển quá nhanh có khả năng gây tổn hại cho nhân loại",
        content:
      ...
      {
        title:
          "Con người nên quan tâm và lo lắng nếu AI (trí thông minh nhân tạo) có thể kiểm soát mọi thứ",
        content:
      ...
      {
        title:
          "Trí tuệ nhân tạo nói riêng và công nghệ nói chung không phải là nguyên nhân duy nhất có thể thay đổi hướng đi của kinh tế thế giới trong tương lai",
        content:
    ...
    description: "AI is so powerful but also very scary",
